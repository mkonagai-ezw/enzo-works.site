(function(root){
 ...
 G.restore=function(raw){
  try{
   ...
   const maxTurn=s.chapter==='party'?6:s.chapter==='leadership'?1:['term','term2','term3','government'].includes(s.chapter)?16:13;
   ...
   if(s.chapter&&!['prologue','term','term2','term3','leadership','party','government'].includes(s.chapter))return null;
   ...
   if(G.People&&!G.People.validate(s))return null;
   if(G.Nominations&&!G.Nominations.validate(s))return null;
   if(s.stage==='event'){
